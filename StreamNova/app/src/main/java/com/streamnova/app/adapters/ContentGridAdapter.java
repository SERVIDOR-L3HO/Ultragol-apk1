...
public class ContentGridAdapter extends RecyclerView.Adapter<ContentGridAdapter.ViewHolder> {
    ...
    public ContentGridAdapter(Context context, List<ContentItem> items) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_grid_card, parent, false);
    ...
    private void showDetailDialog(ContentItem item, int gradIdx) {
        ...
        if (window != null) {
            ...
            lp.width = (int) (context.getResources().getDisplayMetrics().widthPixels * 0.65f);
