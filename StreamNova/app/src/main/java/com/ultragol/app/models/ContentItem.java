...
public class ContentItem {
    ...
    public String getStreamUrl() {
        ...
        String params = "?sub=es&lang=es&audio=es&muted=0&autoplay=1";
        if (contentType == TYPE_MOVIE) {
            return "https://unlimplay.com/play/embed/movie/" + tmdbId + params;
        } else {
            return "https://unlimplay.com/play/embed/tv/" + tmdbId + "/1/1" + params;
        }
    }
