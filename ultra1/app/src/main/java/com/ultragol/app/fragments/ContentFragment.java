...
public class ContentFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        switch (contentType) {
            ...
            case TYPE_SPORTS:
                ...
                if (screenWidthDp >= 600) spanCount = Math.max(2, spanCount - 1);
                break;
            case TYPE_LIVE_TV:
    ...
    private void loadContent() {
        ...
        switch (contentType) {
            ...
            case TYPE_SPORTS:  ContentData.fetchSportsChannels(cb); break;
            case TYPE_LIVE_TV: ContentData.fetchLiveTV(cb);         break;
        }
    }
}
