...
public class HomeFragment extends Fragment {
    ...
    private void loadAllData() {
        ...
        ContentData.fetchSportsChannels(items -> {
            if (!isAdded() || rowSports == null) return;
            refreshRow(rowSports, getString(R.string.section_sports), items);
        });
    }
    ...
    private void applyFilter(String filter) {
        ...
        switch (filter) {
            case "sports":
                ...
                ContentData.fetchSportsChannels(items -> {
                    if (isAdded()) refreshRow(rowSports, "Deportes en Vivo", items);
                });
                break;
            case "movies":
    ...
    private void setupRows(View view) {
        ...
        setupRow(rowSports,      getString(R.string.section_sports),      new ArrayList<>());
    }
